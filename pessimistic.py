...
# Parameters for Pessimistic Scenario
# Parameters for Pessimistic Scenario
ANNUAL_VOLAT = 0.18               # Higher volatility
BID_ASK_SP = 1 / 7               # Wider bid-ask spread
DAILY_TRADE_VOL = 4e6             # Lower daily trading volume
TRAD_DAYS = 220                   # Fewer trading days in a year
EPSILON = BID_ASK_SP / 2                # Higher fixed cost of selling
DAILY_VOLAT = ANNUAL_VOLAT / np.sqrt(TRAD_DAYS) 
LLAMBDA1 = 5e-6                   # Higher trader's risk aversion for agent 1
LLAMBDA2 = 5e-6                   # Higher trader's risk aversion for agent 2
LIQUIDATION_TIME = 40             # Shorter liquidation time
TOTAL_SHARES1 = 450000            # Fewer total shares to sell for agent 1
TOTAL_SHARES2 = 450000            # Fewer total shares to sell for agent 2
STARTING_PRICE = 40               # Lower starting price per share
NUM_N = 50                        # Fewer number of trades
